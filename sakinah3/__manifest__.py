...
* Purchase Analysis
    ...
    'depends': ['sakinah', 'sakinah2', 'point_of_sale', 'website_sale'],
    'data': [
            ...
            'data/sakinah_email_template.xml',
            'views/s_pos_session.xml',
            'views/s_expenses_views.xml',
            'views/s_pos_template.xml',
            'views/s_web_template.xml',
            'views/s_branch.xml',
    	    ],
    'qweb': ['static/src/xml/s_pos.xml'],
    'installable': True,
    'auto_install': False,
    'application': True,
}
